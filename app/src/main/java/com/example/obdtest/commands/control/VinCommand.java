 ...
 * the License.
 */
package com.example.obdtest.commands.control;

import com.example.obdtest.commands.PersistentCommand;
import com.example.obdtest.enums.AvailableCommandNames;
...
//     * Copy ctor.
//     *
//     * @param other a {@link com.example.obdtest.commands.control.VinCommand} object.
//     */
...
//            return "null";
    ...
    private static Pattern BUSINIT_PATTERN = Pattern.compile("(\\.)");

    public String convertHexToString(String hex) {
        hex = removeAll(BUSINIT_PATTERN, hex);
