 ...
 * the License.
 */
package com.example.obdtest.utils;
...
public abstract class CommandAvailabilityHelper {
     ...
     *
     * This is a direct call to {@link com.example.myapplication.utils.CommandAvailabilityHelper#isAvailable(String, int[])} with built-in String digestion
     *
     * @param commandPid a {@link String} object.
     * @param availabilityString a {@link String} object.
     * @return a boolean.
